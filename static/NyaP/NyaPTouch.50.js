...
},{"../lib/Object2HTML/Object2HTML.js":1,"./danmaku.js":61,"./i18n.js":62,"core-js/modules/web.dom.iterable":56}],60:[function(require,module,exports){
/*
Copyright luojia@luojia.me
LGPL license
*/
...
const _ = _i18n.i18n._; //NyaPTouch options
...
class NyaPTouch extends _NyaPCore.NyaPlayerCore {
  constructor(opt) {
    ...
    $.control_bottom.style.marginTop = `-${NP.opt.bottomControlHeight}px`; //add touch drag event to video
        ...
        click: e => {
          if (e.target.color) {
            ...
            if (c) {
              ...
              NP._.danmakuColor = c;
              (0, _NyaPCore.toArray)($.danmaku_color_box.childNodes).forEach(cp => {
              ...
              (0, _NyaPCore.toArray)($.danmaku_color_box.childNodes).forEach(cp => cp.classList.remove('active'));
            }
          }
        }
      },
...
},{"../lib/Object2HTML/Object2HTML.js":1,"./NyaPCore.js":59,"./i18n.js":62,"core-js/modules/web.dom.iterable":56}],61:[function(require,module,exports){
/*
Copyright luojia@luojia.me
LGPL license
*/
...
},{"../lib/danmaku-frame/src/danmaku-frame.js":3,"../lib/danmaku-text/src/danmaku-text.js":6,"./NyaPCore.js":59,"core-js/modules/web.dom.iterable":56}],62:[function(require,module,exports){
"use strict";
...
},{"core-js/modules/web.dom.iterable":56}]},{},[60])
